...
public class RendezVousController {
    ...
    private RendezVousService rendezVousService;
        ...
        @PostMapping
        public ResponseEntity<RendezVousDto> createRendezVous(@RequestBody RendezVousDto rendezVousDto,@RequestParam String email) throws java.io.IOException, MessagingException {
